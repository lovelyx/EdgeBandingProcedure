...
class banding:
    ...
    # 左机封边带编码
    def LeftBandingCode(self, i, panel, PanelBasics, BandingCodingDict):
        """
        左机封边带编码
        :param i: 第几行数据
        :param panel: xml中的panel标签
    ...
    # 左机加工编码
    def LeftProcessCode(self,i, panel, PanelBasics,FinishedLength,FinishedWidth,BandingCodingDict,QRCode,IdFile,CsvIdFileQ,CsvIdFileQL,ProcessingDict,n):
        """
        左机加工编码
        :param i: 第几行数据
        :param panel: xml中的panel标签
    ...
    # 右机封边带编码
    def RigthBandingCode(self,i, panel, PanelBasics, BandingCodingDict,n):
        """
        右机分封边带编码
        :param i: 第几行数据
        :param panel: xml中的panel标签
    ...
    # 右击加工编码
    def RigthProcessCode(self,i, panel, PanelBasics, BandingCodingDict,t,ProcessingDict,CheckBoxf,n):
        """
        右机加工编码
        :param i: 第几行数据
        :param panel: xml中的panel标签
    ...
    def changeWwidth(self,Folderpath,Folderpath2,Folderpath3,Folderpath4,test,styleCell,SqlUnit,IdList,CheckBoxf,username):
            ...
            try:
                ...
                for panel in Panelnodes:
                    ...
                    for i in range(1,3):
                        ...
                        # 13.左机封边带编码
                        n=self.LeftBandingCode(i,panel,PanelBasics,BandingCodingDict)

                        # 14.左机加工编码
                        t = self.LeftProcessCode(i,panel,PanelBasics,FinishedLength,FinishedWidth,BandingCodingDict,QRCode,IdFile,CsvIdFileKc,CsvIdFileQL,ProcessingDict,n)
                        ...
                        # 16.右机封边带编码
                        self.RigthBandingCode(i,panel,PanelBasics,BandingCodingDict,n)


                        # 17.右机加工编码
                        self.RigthProcessCode(i,panel,PanelBasics,BandingCodingDict,t,ProcessingDict,CheckBoxf,n)
        ...
        # return IdList
def main(Folderpath,Folderpath2,Folderpath3,Folderpath4,IdList,CheckBoxf,username):
    # 创建表格对象
    test = My_sheet()
    # 创建样式对象
    styleCell = style()
